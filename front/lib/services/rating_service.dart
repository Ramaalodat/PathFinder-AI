...
class RatingService {
  ...
  static Future<bool> shouldShowRatingPrompt() async {
    ...
    print('📋 RatingService: Session features: $sessionFeatures (count: ${sessionFeatures.length})');
    ...
    print('📋 RatingService: Last prompt: $lastPrompt, Now: $now, Diff: ${now - lastPrompt}ms');
